...
the safe candidates that the absolute q_m constraint admits (the primary branch). select.py
...
# readout is schema-valid and usable; the absolute q_m=Y_true requirement is applied
# afterward as the primary-branch constraint. A candidate that fails that branch
# constraint may still enter the q_m fallback. `correctness` is an independent
